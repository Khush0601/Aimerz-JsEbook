...
//  Create a map that shows all the events happening in a city on a particular date, displaying them with markers and event details.

Example:

function filterEventsByDate(events, eventDate) {
  
  let particularDate=events.filter((el)=>el.date===eventDate)
